...
.method public static declared-synchronized a()Lcom/alibaba/mtl/log/d/r;
    ...
    const-class v0, Lcom/alibaba/mtl/log/d/r;

    monitor-enter v0

    .line 85
    :try_start_0
    sget-object v1, Lcom/alibaba/mtl/log/d/r;->a:Lcom/alibaba/mtl/log/d/r;

    if-nez v1, :cond_0

    .line 86
    new-instance v1, Lcom/alibaba/mtl/log/d/r;

    invoke-direct {v1}, Lcom/alibaba/mtl/log/d/r;-><init>()V

    sput-object v1, Lcom/alibaba/mtl/log/d/r;->a:Lcom/alibaba/mtl/log/d/r;
...
.method private static declared-synchronized a()Ljava/util/concurrent/ThreadPoolExecutor;
    ...
    .line 78
    :try_start_0
    sget-object v1, Lcom/alibaba/mtl/log/d/r;->a:Ljava/util/concurrent/ThreadPoolExecutor;

    if-nez v1, :cond_0

    .line 79
    sget v1, Lcom/alibaba/mtl/log/d/r;->G:I

    sget v2, Lcom/alibaba/mtl/log/d/r;->H:I

    sget v3, Lcom/alibaba/mtl/log/d/r;->I:I

    sget v4, Lcom/alibaba/mtl/log/d/r;->J:I

    const/16 v5, 0x1f4

    invoke-static {v1, v2, v3, v4, v5}, Lcom/alibaba/mtl/log/d/r;->a(IIIII)Ljava/util/concurrent/ThreadPoolExecutor;

    move-result-object v1

    sput-object v1, Lcom/alibaba/mtl/log/d/r;->a:Ljava/util/concurrent/ThreadPoolExecutor;
...
.method public final a(ILjava/lang/Runnable;J)V
    ...
    .line 113
    iget-object p2, p0, Lcom/alibaba/mtl/log/d/r;->mHandler:Landroid/os/Handler;
