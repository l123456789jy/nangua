...
# instance fields
.field private b:Landroid/arch/core/internal/FastSafeIterableMap;
...
.method public constructor <init>(Landroid/arch/lifecycle/LifecycleOwner;)V
    ...
    iput-object v0, p0, Landroid/arch/lifecycle/LifecycleRegistry;->b:Landroid/arch/core/internal/FastSafeIterableMap;

    const/4 v0, 0x0

    .line 74
    iput v0, p0, Landroid/arch/lifecycle/LifecycleRegistry;->e:I

    .line 76
    iput-boolean v0, p0, Landroid/arch/lifecycle/LifecycleRegistry;->f:Z

    .line 77
    iput-boolean v0, p0, Landroid/arch/lifecycle/LifecycleRegistry;->g:Z
    ...
    iput-object v0, p0, Landroid/arch/lifecycle/LifecycleRegistry;->h:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Landroid/arch/lifecycle/LifecycleRegistry;->d:Ljava/lang/ref/WeakReference;

    .line 99
    sget-object p1, Landroid/arch/lifecycle/Lifecycle$State;->INITIALIZED:Landroid/arch/lifecycle/Lifecycle$State;

    iput-object p1, p0, Landroid/arch/lifecycle/LifecycleRegistry;->c:Landroid/arch/lifecycle/Lifecycle$State;
...
.method private a(Landroid/arch/lifecycle/LifecycleObserver;)Landroid/arch/lifecycle/Lifecycle$State;
    ...
    .line 151
    iget-object v0, p0, Landroid/arch/lifecycle/LifecycleRegistry;->b:Landroid/arch/core/internal/FastSafeIterableMap;
    ...
    .line 154
    :goto_0
    iget-object v1, p0, Landroid/arch/lifecycle/LifecycleRegistry;->h:Ljava/util/ArrayList;
    ...
    iget-object v0, p0, Landroid/arch/lifecycle/LifecycleRegistry;->h:Ljava/util/ArrayList;
    ...
    .line 156
    :cond_1
    iget-object v1, p0, Landroid/arch/lifecycle/LifecycleRegistry;->c:Landroid/arch/lifecycle/Lifecycle$State;
...
.method private a(Landroid/arch/lifecycle/Lifecycle$State;)V
    ...
    .line 127
    iget-object v0, p0, Landroid/arch/lifecycle/LifecycleRegistry;->c:Landroid/arch/lifecycle/Lifecycle$State;
    ...
    .line 131
    iget-boolean p1, p0, Landroid/arch/lifecycle/LifecycleRegistry;->f:Z

    const/4 v0, 0x1

    if-nez p1, :cond_2

    iget p1, p0, Landroid/arch/lifecycle/LifecycleRegistry;->e:I
    ...
    .line 138
    iput-boolean p1, p0, Landroid/arch/lifecycle/LifecycleRegistry;->f:Z
...
.method private a(Landroid/arch/lifecycle/LifecycleOwner;)V
    ...
    iget-boolean v1, p0, Landroid/arch/lifecycle/LifecycleRegistry;->g:Z
    ...
    iget-object v4, p0, Landroid/arch/lifecycle/LifecycleRegistry;->c:Landroid/arch/lifecycle/Lifecycle$State;
    ...
    iget-boolean v3, p0, Landroid/arch/lifecycle/LifecycleRegistry;->g:Z

    if-nez v3, :cond_0

    iget-object v3, p0, Landroid/arch/lifecycle/LifecycleRegistry;->b:Landroid/arch/core/internal/FastSafeIterableMap;
...
.method private a()Z
    ...
    .line 146
    iget-object v2, p0, Landroid/arch/lifecycle/LifecycleRegistry;->b:Landroid/arch/core/internal/FastSafeIterableMap;
...
.method private c()V
    ...
    .line 317
    iget-object v0, p0, Landroid/arch/lifecycle/LifecycleRegistry;->d:Ljava/lang/ref/WeakReference;
    ...
    .line 324
    iput-boolean v2, p0, Landroid/arch/lifecycle/LifecycleRegistry;->g:Z
    ...
    .line 329
    :cond_1
    iget-object v1, p0, Landroid/arch/lifecycle/LifecycleRegistry;->b:Landroid/arch/core/internal/FastSafeIterableMap;
    ...
    .line 330
    iget-boolean v2, p0, Landroid/arch/lifecycle/LifecycleRegistry;->g:Z

    if-nez v2, :cond_0

    if-eqz v1, :cond_0

    iget-object v2, p0, Landroid/arch/lifecycle/LifecycleRegistry;->c:Landroid/arch/lifecycle/Lifecycle$State;
...
.method public addObserver(Landroid/arch/lifecycle/LifecycleObserver;)V
    ...
    .line 174
    :cond_2
    iget v2, p0, Landroid/arch/lifecycle/LifecycleRegistry;->e:I
    ...
    .line 176
    iget v5, p0, Landroid/arch/lifecycle/LifecycleRegistry;->e:I

    add-int/2addr v5, v3

    iput v5, p0, Landroid/arch/lifecycle/LifecycleRegistry;->e:I
    ...
    iget-object v4, p0, Landroid/arch/lifecycle/LifecycleRegistry;->b:Landroid/arch/core/internal/FastSafeIterableMap;
    ...
    iput p1, p0, Landroid/arch/lifecycle/LifecycleRegistry;->e:I
