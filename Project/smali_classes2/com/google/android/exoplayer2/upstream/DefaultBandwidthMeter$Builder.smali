...
.field private c:Lcom/google/android/exoplayer2/upstream/BandwidthMeter$EventListener;
    .annotation build Landroid/support/annotation/Nullable;
    .end annotation
.end field
...
.field private f:Lcom/google/android/exoplayer2/util/Clock;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-static {p1}, Lcom/google/android/exoplayer2/upstream/DefaultBandwidthMeter$Builder;->a(Ljava/lang/String;)Landroid/util/SparseArray;

    move-result-object p1

    iput-object p1, p0, Lcom/google/android/exoplayer2/upstream/DefaultBandwidthMeter$Builder;->d:Landroid/util/SparseArray;

    const/16 p1, 0x7d0

    .line 99
    iput p1, p0, Lcom/google/android/exoplayer2/upstream/DefaultBandwidthMeter$Builder;->e:I

    .line 100
    sget-object p1, Lcom/google/android/exoplayer2/util/Clock;->DEFAULT:Lcom/google/android/exoplayer2/util/Clock;

    iput-object p1, p0, Lcom/google/android/exoplayer2/upstream/DefaultBandwidthMeter$Builder;->f:Lcom/google/android/exoplayer2/util/Clock;
...
.method private static a(Ljava/lang/String;)Landroid/util/SparseArray;
    ...
    .line 203
    invoke-static {p0}, Lcom/google/android/exoplayer2/upstream/DefaultBandwidthMeter$Builder;->b(Ljava/lang/String;)[I
...
.method public build()Lcom/google/android/exoplayer2/upstream/DefaultBandwidthMeter;
    ...
    .line 190
    iget-object v0, p0, Lcom/google/android/exoplayer2/upstream/DefaultBandwidthMeter$Builder;->d:Landroid/util/SparseArray;
    ...
    iget v4, p0, Lcom/google/android/exoplayer2/upstream/DefaultBandwidthMeter$Builder;->e:I

    iget-object v5, p0, Lcom/google/android/exoplayer2/upstream/DefaultBandwidthMeter$Builder;->f:Lcom/google/android/exoplayer2/util/Clock;
    ...
    .line 196
    iget-object v0, p0, Lcom/google/android/exoplayer2/upstream/DefaultBandwidthMeter$Builder;->b:Landroid/os/Handler;

    if-eqz v0, :cond_1

    iget-object v0, p0, Lcom/google/android/exoplayer2/upstream/DefaultBandwidthMeter$Builder;->c:Lcom/google/android/exoplayer2/upstream/BandwidthMeter$EventListener;
    ...
    iget-object v1, p0, Lcom/google/android/exoplayer2/upstream/DefaultBandwidthMeter$Builder;->c:Lcom/google/android/exoplayer2/upstream/BandwidthMeter$EventListener;
...
.method public setEventListener(Landroid/os/Handler;Lcom/google/android/exoplayer2/upstream/BandwidthMeter$EventListener;)Lcom/google/android/exoplayer2/upstream/DefaultBandwidthMeter$Builder;
    ...
    .line 113
    iput-object p1, p0, Lcom/google/android/exoplayer2/upstream/DefaultBandwidthMeter$Builder;->b:Landroid/os/Handler;

    .line 114
    iput-object p2, p0, Lcom/google/android/exoplayer2/upstream/DefaultBandwidthMeter$Builder;->c:Lcom/google/android/exoplayer2/upstream/BandwidthMeter$EventListener;
...
.method public setInitialBitrateEstimate(J)Lcom/google/android/exoplayer2/upstream/DefaultBandwidthMeter$Builder;
    ...
    .line 137
    :goto_0
    iget-object v1, p0, Lcom/google/android/exoplayer2/upstream/DefaultBandwidthMeter$Builder;->d:Landroid/util/SparseArray;
