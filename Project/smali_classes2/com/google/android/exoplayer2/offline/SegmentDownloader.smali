...
.field private final d:Lcom/google/android/exoplayer2/upstream/cache/Cache;

.field private final e:Lcom/google/android/exoplayer2/upstream/cache/CacheDataSource;

.field private final f:Lcom/google/android/exoplayer2/upstream/cache/CacheDataSource;
...
.method public constructor <init>(Landroid/net/Uri;Ljava/util/List;Lcom/google/android/exoplayer2/offline/DownloaderConstructorHelper;)V
    ...
    .line 84
    iput-object p1, p0, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->b:Landroid/net/Uri;
    ...
    iput-object p1, p0, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->g:Ljava/util/ArrayList;
    ...
    iput-object p1, p0, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->d:Lcom/google/android/exoplayer2/upstream/cache/Cache;
    ...
    iput-object p1, p0, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->e:Lcom/google/android/exoplayer2/upstream/cache/CacheDataSource;
    ...
    iput-object p1, p0, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->f:Lcom/google/android/exoplayer2/upstream/cache/CacheDataSource;
    ...
    iput-object p1, p0, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->c:Lcom/google/android/exoplayer2/util/PriorityTaskManager;

    const/4 p1, -0x1

    .line 90
    iput p1, p0, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->i:I
    ...
    iput-object p1, p0, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->h:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method private a()Ljava/util/List;
    ...
    .line 205
    iget-object v0, p0, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->e:Lcom/google/android/exoplayer2/upstream/cache/CacheDataSource;

    iget-object v1, p0, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->b:Landroid/net/Uri;
    ...
    .line 206
    iget-object v1, p0, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->g:Ljava/util/ArrayList;
    ...
    .line 209
    :cond_0
    iget-object v1, p0, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->e:Lcom/google/android/exoplayer2/upstream/cache/CacheDataSource;
    ...
    iput v3, p0, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->i:I

    .line 212
    iput v2, p0, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->j:I

    const-wide/16 v2, 0x0

    .line 213
    iput-wide v2, p0, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->k:J
    ...
    iget-object v4, p0, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->d:Lcom/google/android/exoplayer2/upstream/cache/Cache;
    ...
    .line 217
    iget-wide v3, p0, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->k:J

    iget-wide v5, v1, Lcom/google/android/exoplayer2/upstream/cache/CacheUtil$CachingCounters;->alreadyCachedBytes:J

    add-long v7, v3, v5

    iput-wide v7, p0, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->k:J
    ...
    .line 220
    iget v3, p0, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->j:I

    add-int/lit8 v3, v3, 0x1

    iput v3, p0, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->j:I
...
.method private a(Landroid/net/Uri;)V
    ...
    .line 228
    iget-object v0, p0, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->d:Lcom/google/android/exoplayer2/upstream/cache/Cache;
...
.method public cancel()V
    ...
    .line 137
    iget-object v0, p0, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->h:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public final download()V
    ...
    .line 106
    iget-object v0, p0, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->c:Lcom/google/android/exoplayer2/util/PriorityTaskManager;
    ...
    .line 109
    :try_start_0
    invoke-direct {p0}, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->a()Ljava/util/List;
    ...
    iget-object v5, p0, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->e:Lcom/google/android/exoplayer2/upstream/cache/CacheDataSource;

    iget-object v7, p0, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->c:Lcom/google/android/exoplayer2/util/PriorityTaskManager;

    const/16 v8, -0x3e8

    iget-object v10, p0, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->h:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    iget-wide v2, p0, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->k:J

    iget-wide v4, v12, Lcom/google/android/exoplayer2/upstream/cache/CacheUtil$CachingCounters;->newlyCachedBytes:J

    add-long v6, v2, v4

    iput-wide v6, p0, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->k:J
    ...
    iget-object v2, p0, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->c:Lcom/google/android/exoplayer2/util/PriorityTaskManager;
...
.method public final getDownloadPercentage()F
    ...
    .line 148
    iget v0, p0, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->i:I

    .line 149
    iget v1, p0, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->j:I
...
.method public final getDownloadedBytes()J
    ...
    .line 142
    iget-wide v0, p0, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->k:J
...
.method public final remove()V
    ...
    .line 159
    :try_start_0
    iget-object v0, p0, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->f:Lcom/google/android/exoplayer2/upstream/cache/CacheDataSource;
    ...
    .line 160
    iget-object v1, p0, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->f:Lcom/google/android/exoplayer2/upstream/cache/CacheDataSource;
    ...
    invoke-direct {p0, v2}, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->a(Landroid/net/Uri;)V
    :try_end_0
    ...
    invoke-direct {p0, v1}, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->a(Landroid/net/Uri;)V
    ...
    :catch_0
    :cond_0
    iget-object v0, p0, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->b:Landroid/net/Uri;

    invoke-direct {p0, v0}, Lcom/google/android/exoplayer2/offline/SegmentDownloader;->a(Landroid/net/Uri;)V
