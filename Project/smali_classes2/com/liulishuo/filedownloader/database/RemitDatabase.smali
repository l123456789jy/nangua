...
# instance fields
.field private final a:Lcom/liulishuo/filedownloader/database/NoDatabaseImpl;

.field private final b:Lcom/liulishuo/filedownloader/database/SqliteDatabaseImpl;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/liulishuo/filedownloader/database/RemitDatabase;->e:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/liulishuo/filedownloader/database/RemitDatabase;->f:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    iput-object v0, p0, Lcom/liulishuo/filedownloader/database/RemitDatabase;->a:Lcom/liulishuo/filedownloader/database/NoDatabaseImpl;
    ...
    iput-object v0, p0, Lcom/liulishuo/filedownloader/database/RemitDatabase;->b:Lcom/liulishuo/filedownloader/database/SqliteDatabaseImpl;
    ...
    iput-wide v0, p0, Lcom/liulishuo/filedownloader/database/RemitDatabase;->d:J
    ...
    iput-object v1, p0, Lcom/liulishuo/filedownloader/database/RemitDatabase;->c:Landroid/os/Handler;

    return-void
.end method

.method static synthetic a(Lcom/liulishuo/filedownloader/database/RemitDatabase;)Ljava/lang/Thread;
    .locals 0

    .line 39
    iget-object p0, p0, Lcom/liulishuo/filedownloader/database/RemitDatabase;->g:Ljava/lang/Thread;

    return-object p0
.end method

.method static synthetic a(Lcom/liulishuo/filedownloader/database/RemitDatabase;Ljava/lang/Thread;)Ljava/lang/Thread;
    .locals 0

    .line 39
    iput-object p1, p0, Lcom/liulishuo/filedownloader/database/RemitDatabase;->g:Ljava/lang/Thread;
...
.method private a(I)V
    ...
    .line 100
    :cond_0
    iget-object v0, p0, Lcom/liulishuo/filedownloader/database/RemitDatabase;->b:Lcom/liulishuo/filedownloader/database/SqliteDatabaseImpl;

    iget-object v1, p0, Lcom/liulishuo/filedownloader/database/RemitDatabase;->a:Lcom/liulishuo/filedownloader/database/NoDatabaseImpl;
    ...
    .line 101
    iget-object v0, p0, Lcom/liulishuo/filedownloader/database/RemitDatabase;->a:Lcom/liulishuo/filedownloader/database/NoDatabaseImpl;
    ...
    .line 102
    iget-object v1, p0, Lcom/liulishuo/filedownloader/database/RemitDatabase;->b:Lcom/liulishuo/filedownloader/database/SqliteDatabaseImpl;
...
.method static synthetic a(Lcom/liulishuo/filedownloader/database/RemitDatabase;I)V
    .locals 0

    .line 39
    invoke-direct {p0, p1}, Lcom/liulishuo/filedownloader/database/RemitDatabase;->a(I)V

    return-void
.end method

.method static synthetic b(Lcom/liulishuo/filedownloader/database/RemitDatabase;)Ljava/util/concurrent/atomic/AtomicInteger;
    .locals 0

    .line 39
    iget-object p0, p0, Lcom/liulishuo/filedownloader/database/RemitDatabase;->f:Ljava/util/concurrent/atomic/AtomicInteger;
...
.method private b(I)Z
    ...
    .line 109
    iget-object v0, p0, Lcom/liulishuo/filedownloader/database/RemitDatabase;->e:Ljava/util/List;
...
.method static synthetic c(Lcom/liulishuo/filedownloader/database/RemitDatabase;)Ljava/util/List;
    .locals 0

    .line 39
    iget-object p0, p0, Lcom/liulishuo/filedownloader/database/RemitDatabase;->e:Ljava/util/List;
...
.method private c(I)V
    ...
    .line 206
    iget-object v0, p0, Lcom/liulishuo/filedownloader/database/RemitDatabase;->c:Landroid/os/Handler;

    invoke-virtual {v0, p1}, Landroid/os/Handler;->removeMessages(I)V

    .line 207
    iget-object v0, p0, Lcom/liulishuo/filedownloader/database/RemitDatabase;->f:Ljava/util/concurrent/atomic/AtomicInteger;
    ...
    .line 209
    iget-object p1, p0, Lcom/liulishuo/filedownloader/database/RemitDatabase;->c:Landroid/os/Handler;
...
.method public insert(Lcom/liulishuo/filedownloader/model/FileDownloadModel;)V
    ...
    invoke-direct {p0, v0}, Lcom/liulishuo/filedownloader/database/RemitDatabase;->b(I)Z
...
.method public maintainer()Lcom/liulishuo/filedownloader/database/FileDownloadDatabase$Maintainer;
    ...
    iget-object v1, v1, Lcom/liulishuo/filedownloader/database/NoDatabaseImpl;->a:Landroid/util/SparseArray;

    iget-object v2, p0, Lcom/liulishuo/filedownloader/database/RemitDatabase;->a:Lcom/liulishuo/filedownloader/database/NoDatabaseImpl;

    iget-object v2, v2, Lcom/liulishuo/filedownloader/database/NoDatabaseImpl;->b:Landroid/util/SparseArray;
...
.method public onTaskStart(I)V
    ...
    iget-wide v1, p0, Lcom/liulishuo/filedownloader/database/RemitDatabase;->d:J
...
.method public removeConnections(I)V
    ...
    .line 126
    invoke-direct {p0, p1}, Lcom/liulishuo/filedownloader/database/RemitDatabase;->b(I)Z
...
.method public updateCompleted(IJ)V
    ...
    iput-object v0, p0, Lcom/liulishuo/filedownloader/database/RemitDatabase;->g:Ljava/lang/Thread;
    ...
    :cond_1
    :goto_0
    iget-object p2, p0, Lcom/liulishuo/filedownloader/database/RemitDatabase;->e:Ljava/util/List;
...
.method public updateError(ILjava/lang/Throwable;J)V
    ...
    .line 219
    invoke-direct {p0, p1}, Lcom/liulishuo/filedownloader/database/RemitDatabase;->c(I)V
...
.method public updateOldEtagOverdue(ILjava/lang/String;JJI)V
    ...
    .line 182
    iget-object v1, v0, Lcom/liulishuo/filedownloader/database/RemitDatabase;->a:Lcom/liulishuo/filedownloader/database/NoDatabaseImpl;
    ...
    .line 183
    invoke-direct {v0, p1}, Lcom/liulishuo/filedownloader/database/RemitDatabase;->b(I)Z
    ...
    .line 184
    :cond_0
    iget-object v2, v0, Lcom/liulishuo/filedownloader/database/RemitDatabase;->b:Lcom/liulishuo/filedownloader/database/SqliteDatabaseImpl;
