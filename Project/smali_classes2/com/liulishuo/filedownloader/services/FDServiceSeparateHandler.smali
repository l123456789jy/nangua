...
.implements Lcom/liulishuo/filedownloader/services/c;
...
.field private final q:Lcom/liulishuo/filedownloader/services/a;
...
# direct methods
.method constructor <init>(Ljava/lang/ref/WeakReference;Lcom/liulishuo/filedownloader/services/a;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object v0, p0, Lcom/liulishuo/filedownloader/services/FDServiceSeparateHandler;->p:Landroid/os/RemoteCallbackList;

    .line 62
    iput-object p1, p0, Lcom/liulishuo/filedownloader/services/FDServiceSeparateHandler;->r:Ljava/lang/ref/WeakReference;

    .line 63
    iput-object p2, p0, Lcom/liulishuo/filedownloader/services/FDServiceSeparateHandler;->q:Lcom/liulishuo/filedownloader/services/a;
...
.method private declared-synchronized a(Lcom/liulishuo/filedownloader/message/MessageSnapshot;)I
    .locals 4
    ...
    .line 46
    :try_start_0
    iget-object v0, p0, Lcom/liulishuo/filedownloader/services/FDServiceSeparateHandler;->p:Landroid/os/RemoteCallbackList;
    ...
    .line 49
    :try_start_1
    iget-object v3, p0, Lcom/liulishuo/filedownloader/services/FDServiceSeparateHandler;->p:Landroid/os/RemoteCallbackList;
    ...
    .line 54
    :try_start_3
    iget-object p1, p0, Lcom/liulishuo/filedownloader/services/FDServiceSeparateHandler;->p:Landroid/os/RemoteCallbackList;
...
.method public checkDownloading(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    .line 80
    iget-object v0, p0, Lcom/liulishuo/filedownloader/services/FDServiceSeparateHandler;->q:Lcom/liulishuo/filedownloader/services/a;

    invoke-virtual {v0, p1, p2}, Lcom/liulishuo/filedownloader/services/a;->a(Ljava/lang/String;Ljava/lang/String;)Z
...
.method public clearAllTaskData()V
    ...
    invoke-virtual {v0}, Lcom/liulishuo/filedownloader/services/a;->c()V
...
.method public clearTaskData(I)Z
    ...
    invoke-virtual {v0, p1}, Lcom/liulishuo/filedownloader/services/a;->g(I)Z
...
.method public getSofar(I)J
    ...
    invoke-virtual {v0, p1}, Lcom/liulishuo/filedownloader/services/a;->c(I)J
...
.method public getStatus(I)B
    ...
    invoke-virtual {v0, p1}, Lcom/liulishuo/filedownloader/services/a;->e(I)B
...
.method public getTotal(I)J
    ...
    invoke-virtual {v0, p1}, Lcom/liulishuo/filedownloader/services/a;->d(I)J
...
.method public isIdle()Z
    ...
    invoke-virtual {v0}, Lcom/liulishuo/filedownloader/services/a;->b()Z
...
.method public pause(I)Z
    ...
    invoke-virtual {v0, p1}, Lcom/liulishuo/filedownloader/services/a;->b(I)Z
...
.method public pauseAllTasks()V
    ...
    invoke-virtual {v0}, Lcom/liulishuo/filedownloader/services/a;->a()V
...
.method public receive(Lcom/liulishuo/filedownloader/message/MessageSnapshot;)V
    ...
    .line 168
    invoke-direct {p0, p1}, Lcom/liulishuo/filedownloader/services/FDServiceSeparateHandler;->a(Lcom/liulishuo/filedownloader/message/MessageSnapshot;)I
...
.method public setMaxNetworkThreadCount(I)Z
    ...
    invoke-virtual {v0, p1}, Lcom/liulishuo/filedownloader/services/a;->f(I)Z
...
.method public start(Ljava/lang/String;Ljava/lang/String;ZIIIZLcom/liulishuo/filedownloader/model/FileDownloadHeader;Z)V
    ...
    .line 88
    iget-object v1, v0, Lcom/liulishuo/filedownloader/services/FDServiceSeparateHandler;->q:Lcom/liulishuo/filedownloader/services/a;
    ...
    invoke-virtual/range {v1 .. v10}, Lcom/liulishuo/filedownloader/services/a;->a(Ljava/lang/String;Ljava/lang/String;ZIIIZLcom/liulishuo/filedownloader/model/FileDownloadHeader;Z)V
...
.method public startForeground(ILandroid/app/Notification;)V
    ...
    .line 130
    iget-object v0, p0, Lcom/liulishuo/filedownloader/services/FDServiceSeparateHandler;->r:Ljava/lang/ref/WeakReference;
