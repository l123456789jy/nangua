...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/liulishuo/filedownloader/FileDownloader$a;
    }
.end annotation
...
# instance fields
.field private b:Lcom/liulishuo/filedownloader/IQueuesHandler;

.field private d:Lcom/liulishuo/filedownloader/ILostServiceConnectedHandler;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/liulishuo/filedownloader/FileDownloader;->a:Ljava/lang/Object;
    ...
    sput-object v0, Lcom/liulishuo/filedownloader/FileDownloader;->c:Ljava/lang/Object;
...
.method public static getImpl()Lcom/liulishuo/filedownloader/FileDownloader;
    ...
    .line 134
    invoke-static {}, Lcom/liulishuo/filedownloader/FileDownloader$a;->a()Lcom/liulishuo/filedownloader/FileDownloader;
...
.method public static setGlobalHandleSubPackageSize(I)V
    ...
    .line 178
    :cond_0
    sput p0, Lcom/liulishuo/filedownloader/FileDownloadMessageStation;->d:I
...
.method public static setGlobalPost2UIInterval(I)V
    ...
    .line 156
    sput p0, Lcom/liulishuo/filedownloader/FileDownloadMessageStation;->c:I
...
# virtual methods
.method a()Lcom/liulishuo/filedownloader/IQueuesHandler;
    .locals 2

    .line 736
    iget-object v0, p0, Lcom/liulishuo/filedownloader/FileDownloader;->b:Lcom/liulishuo/filedownloader/IQueuesHandler;

    if-nez v0, :cond_1

    .line 737
    sget-object v0, Lcom/liulishuo/filedownloader/FileDownloader;->a:Ljava/lang/Object;

    monitor-enter v0

    .line 738
    :try_start_0
    iget-object v1, p0, Lcom/liulishuo/filedownloader/FileDownloader;->b:Lcom/liulishuo/filedownloader/IQueuesHandler;

    if-nez v1, :cond_0

    .line 739
    new-instance v1, Lcom/liulishuo/filedownloader/e;

    invoke-direct {v1}, Lcom/liulishuo/filedownloader/e;-><init>()V

    iput-object v1, p0, Lcom/liulishuo/filedownloader/FileDownloader;->b:Lcom/liulishuo/filedownloader/IQueuesHandler;
...
.method b()Lcom/liulishuo/filedownloader/ILostServiceConnectedHandler;
    .locals 2

    .line 750
    iget-object v0, p0, Lcom/liulishuo/filedownloader/FileDownloader;->d:Lcom/liulishuo/filedownloader/ILostServiceConnectedHandler;

    if-nez v0, :cond_1

    .line 751
    sget-object v0, Lcom/liulishuo/filedownloader/FileDownloader;->c:Ljava/lang/Object;

    monitor-enter v0

    .line 752
    :try_start_0
    iget-object v1, p0, Lcom/liulishuo/filedownloader/FileDownloader;->d:Lcom/liulishuo/filedownloader/ILostServiceConnectedHandler;
    ...
    iput-object v1, p0, Lcom/liulishuo/filedownloader/FileDownloader;->d:Lcom/liulishuo/filedownloader/ILostServiceConnectedHandler;
...
.method public pause(I)I
    ...
    .line 284
    invoke-virtual {v0, p1}, Lcom/liulishuo/filedownloader/FileDownloadList;->c(I)Ljava/util/List;
...
.method public pause(Lcom/liulishuo/filedownloader/FileDownloadListener;)V
    ...
    invoke-virtual {v0, p1}, Lcom/liulishuo/filedownloader/c;->a(Lcom/liulishuo/filedownloader/FileDownloadListener;)V
    ...
    invoke-virtual {v0, p1}, Lcom/liulishuo/filedownloader/FileDownloadList;->a(Lcom/liulishuo/filedownloader/FileDownloadListener;)Ljava/util/List;
...
.method public pauseAll()V
    ...
    invoke-virtual {v0}, Lcom/liulishuo/filedownloader/c;->b()V
    ...
    invoke-virtual {v0}, Lcom/liulishuo/filedownloader/FileDownloadList;->c()[Lcom/liulishuo/filedownloader/BaseDownloadTask$IRunningTask;
...
.method public setMaxNetworkThreadCount(I)Z
    ...
    invoke-virtual {v0}, Lcom/liulishuo/filedownloader/FileDownloadList;->a()Z

    move-result v0

    if-nez v0, :cond_0

    const-string p1, "Can\'t change the max network thread count, because there are actively executing tasks in FileDownloader, please try again after all actively executing tasks are completed or invoking FileDownloader#pauseAll directly."
...
.method public setTaskCompleted(Ljava/lang/String;Ljava/lang/String;J)Z
    ...
    const-string p1, "If you invoked this method, please remove it directly feel free, it doesn\'t need any longer"
...
.method public start(Lcom/liulishuo/filedownloader/FileDownloadListener;Z)Z
    ...
    .line 237
    invoke-virtual {p0}, Lcom/liulishuo/filedownloader/FileDownloader;->a()Lcom/liulishuo/filedownloader/IQueuesHandler;
