...
.method private static a(Landroid/content/Context;Z)Z
    ...
    sget v2, Lcom/huawei/android/pushagent/PushReceiver;->a:I
    ...
    sget p0, Lcom/huawei/android/pushagent/PushReceiver;->a:I
...
.method private b(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static {p1}, Lcom/huawei/android/pushagent/PushReceiver;->isFrameworkPushExist(Landroid/content/Context;)Z
...
.method public static final enableReceiveNormalMsg(Landroid/content/Context;Z)V
    ...
    const-string p0, "normal_msg_enable"

    xor-int/lit8 p1, p1, 0x1

    invoke-virtual {v0, p0, p1}, Lcom/huawei/android/pushagent/a/a/e;->a(Ljava/lang/String;Z)V
...
.method public static getPushState(Landroid/content/Context;)V
    ...
    invoke-static {p0}, Lcom/huawei/android/pushagent/PushReceiver;->isFrameworkPushExist(Landroid/content/Context;)Z
...
.method public static final getToken(Landroid/content/Context;)V
    ...
    invoke-virtual {v0, p0, v1}, Lcom/huawei/android/pushagent/a/a/e;->a(Ljava/lang/String;Z)V

    return-void
.end method

.method public static declared-synchronized isFrameworkPushExist(Landroid/content/Context;)Z
    .locals 5

    const-class v0, Lcom/huawei/android/pushagent/PushReceiver;
    ...
    sget v3, Lcom/huawei/android/pushagent/PushReceiver;->a:I
    ...
    :cond_1
    :try_start_1
    invoke-static {p0, v4}, Lcom/huawei/android/pushagent/PushReceiver;->a(Landroid/content/Context;Z)Z

    move-result p0

    if-eqz p0, :cond_2

    sput v4, Lcom/huawei/android/pushagent/PushReceiver;->a:I

    goto :goto_0

    :cond_2
    sput v3, Lcom/huawei/android/pushagent/PushReceiver;->a:I
...
.method public final onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    invoke-static {p1, v3, v4}, Lcom/huawei/android/pushagent/a/a/d;->a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    new-instance v2, Lcom/huawei/android/pushagent/PushReceiver$HandlePushTokenThread;

    invoke-direct {v2, p1, v1}, Lcom/huawei/android/pushagent/PushReceiver$HandlePushTokenThread;-><init>(Landroid/content/Context;Ljava/lang/String;)V

    invoke-virtual {v2}, Lcom/huawei/android/pushagent/PushReceiver$HandlePushTokenThread;->start()V
